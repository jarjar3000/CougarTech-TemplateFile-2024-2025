...
/*
  Accumulator
*/
motor bottomAccumulatorL = motor(PORT19, ratio6_1, true);
motor bottomAccumulatorR = motor(PORT20, ratio6_1, false);
...
digital_out hang1 = digital_out(Brain.ThreeWirePort.D);
